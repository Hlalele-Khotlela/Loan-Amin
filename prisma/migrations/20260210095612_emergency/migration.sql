/*
  ...
  - The values [withdraw] on the enum `EmegencyFundTransactionsType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "EmegencyFundTransactionsType_new" AS ENUM ('deposit', 'withdrawal');
